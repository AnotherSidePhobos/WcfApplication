...
namespace ClientApp.ServiceReference1 {
    ...
    public interface IAppService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppService/ShowInfoAboutUsers", ReplyAction="http://tempuri.org/IAppService/ShowInfoAboutUsersResponse")]
        string ShowInfoAboutUsers();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppService/ShowInfoAboutUsers", ReplyAction="http://tempuri.org/IAppService/ShowInfoAboutUsersResponse")]
        System.Threading.Tasks.Task<string> ShowInfoAboutUsersAsync();
        ...
        WcfApplication.ServerUser Edit(int id, string name, string secondName, string nameOfFamily, string faculty, int age, int course);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppService/Edit", ReplyAction="http://tempuri.org/IAppService/EditResponse")]
        System.Threading.Tasks.Task<WcfApplication.ServerUser> EditAsync(int id, string name, string secondName, string nameOfFamily, string faculty, int age, int course);
        ...
        WcfApplication.ServerUser Save(int countUsers, string name, string secondName, string nameOfFamily, string faculty, int age, int course);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppService/Save", ReplyAction="http://tempuri.org/IAppService/SaveResponse")]
        System.Threading.Tasks.Task<WcfApplication.ServerUser> SaveAsync(int countUsers, string name, string secondName, string nameOfFamily, string faculty, int age, int course);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAppServiceChannel : ClientApp.ServiceReference1.IAppService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AppServiceClient : System.ServiceModel.ClientBase<ClientApp.ServiceReference1.IAppService>, ClientApp.ServiceReference1.IAppService {
        ...
        public string ShowInfoAboutUsers() {
            return base.Channel.ShowInfoAboutUsers();
        }
        
        public System.Threading.Tasks.Task<string> ShowInfoAboutUsersAsync() {
            return base.Channel.ShowInfoAboutUsersAsync();
        }
        ...
        public WcfApplication.ServerUser Edit(int id, string name, string secondName, string nameOfFamily, string faculty, int age, int course) {
            return base.Channel.Edit(id, name, secondName, nameOfFamily, faculty, age, course);
        }
        
        public System.Threading.Tasks.Task<WcfApplication.ServerUser> EditAsync(int id, string name, string secondName, string nameOfFamily, string faculty, int age, int course) {
        ...
        public WcfApplication.ServerUser Save(int countUsers, string name, string secondName, string nameOfFamily, string faculty, int age, int course) {
            return base.Channel.Save(countUsers, name, secondName, nameOfFamily, faculty, age, course);
        }
        
        public System.Threading.Tasks.Task<WcfApplication.ServerUser> SaveAsync(int countUsers, string name, string secondName, string nameOfFamily, string faculty, int age, int course) {
